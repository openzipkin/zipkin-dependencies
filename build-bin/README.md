...
Most notably, this is pinned to JDK 1.8 until Elasticsearch updates their Spark driver.
...
* [../.github/workflows/readme_test.yml] tests build commands in [../README.md] and [../docker]
  * Docker build uses `RELEASE_FROM_MAVEN_BUILD=true`
