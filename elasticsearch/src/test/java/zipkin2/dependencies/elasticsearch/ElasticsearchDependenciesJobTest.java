...
public class ElasticsearchDependenciesJobTest {
  ...
  public void parseHosts_default() {
    Assertions.assertThat(ElasticsearchDependenciesJob.parseHosts("1.1.1.1")).isEqualTo("1.1.1.1");
  }

  @Test
  public void parseHosts_commaDelimits() {
    Assertions.assertThat(ElasticsearchDependenciesJob.parseHosts("1.1.1.1:9200,2.2.2.2:9200")).isEqualTo("1.1.1.1:9200,2.2.2.2:9200");
  }

  @Test
  public void parseHosts_http_defaultPort() {
    Assertions.assertThat(ElasticsearchDependenciesJob.parseHosts("http://1.1.1.1")).isEqualTo("1.1.1.1:80");
  }

  @Test
  public void parseHosts_https_defaultPort() {
    Assertions.assertThat(ElasticsearchDependenciesJob.parseHosts("https://1.1.1.1")).isEqualTo("1.1.1.1:443");
  }
