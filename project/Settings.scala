...
object Settings extends Build {
  ...
  lazy val buildSettings = Seq(
    ...
    normalizedName := "zipkindependencies",
    organization := "org.openzipkin.dependencies",
    organizationHomepage := Some(url("http://www.github.com/openzipkin")),
    scalaVersion := Versions.Scala,
    homepage := Some(url("https://github.com/openzipkin/zipkin-dependencies-spark")),
